...
$this->privates['console.command.translation_update'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\TranslationUpdateCommand($a, ($this->privates['translation.reader'] ?? $this->load('getTranslation_ReaderService.php')), ($this->privates['translation.extractor'] ?? $this->load('getTranslation_ExtractorService.php')), 'en', ($this->targetDirs[3].'/translations'), ($this->targetDirs[3].'/templates'), [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations')], [0 => ($this->targetDirs[3].'/vendor/symfony/twig-bridge/Resources/views/Form'), 1 => ($this->targetDirs[3].'/vendor/symfony/http-kernel/EventListener/LocaleAwareListener.php'), 2 => ($this->targetDirs[3].'/vendor/symfony/framework-bundle/Command/TranslationDebugCommand.php'), 3 => ($this->targetDirs[3].'/vendor/symfony/form/Extension/Core/Type/FileType.php'), 4 => ($this->targetDirs[3].'/vendor/symfony/form/Extension/Core/Type/TransformationFailureExtension.php'), 5 => ($this->targetDirs[3].'/vendor/symfony/form/Extension/Validator/Type/UploadValidatorExtension.php'), 6 => ($this->targetDirs[3].'/vendor/symfony/validator/Util/LegacyTranslatorProxy.php'), 7 => ($this->targetDirs[3].'/vendor/symfony/framework-bundle/CacheWarmer/TranslationsCacheWarmer.php'), 8 => ($this->targetDirs[3].'/vendor/symfony/twig-bridge/Extension/TranslationExtension.php'), 9 => ($this->targetDirs[3].'/vendor/jms/serializer/src/Handler/FormErrorHandler.php')]);
