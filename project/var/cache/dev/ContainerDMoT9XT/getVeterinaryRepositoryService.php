...
// Returns the private 'App\Repository\VeterinaryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VeterinaryRepository.php';

return $this->privates['App\\Repository\\VeterinaryRepository'] = new \App\Repository\VeterinaryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
