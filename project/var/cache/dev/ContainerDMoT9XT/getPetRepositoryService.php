...
// Returns the private 'App\Repository\PetRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PetRepository.php';

return $this->privates['App\\Repository\\PetRepository'] = new \App\Repository\PetRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
