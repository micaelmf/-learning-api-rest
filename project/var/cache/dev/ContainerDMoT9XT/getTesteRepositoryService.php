...
// Returns the private 'App\Repository\TesteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TesteRepository.php';

return $this->privates['App\\Repository\\TesteRepository'] = new \App\Repository\TesteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
